    ...
    <div class="row">
        <div class="col-lg-9 col-12 mx-auto">
            <div class="card card-body mt-4">
                <h6 class="mb-0 text-center">CREAT NEW CLIENT</h6>
                <hr class="horizontal dark my-3">

                <form action="{{ route('client.store') }}" method="POST" id="client-form" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-6"><label for="contact" class="form-label">Contact <span
                                    style="color: red">*</span></label>
                            <input type="text" class="form-control" id="contact" name="contact" placeholder="Ex :- 0761234567">
                        </div>
                    ...
                    <div class="d-flex justify-content-end mt-4">
                        ...
                        <button type="submit" class="btn bg-primary m-0 ms-2">Save</button>
                    </div>
                </form>
            </div>
        </div>
...
{!! JsValidator::formRequest('App\Http\Requests\StoreClientRequest', '#client-form') !!}
